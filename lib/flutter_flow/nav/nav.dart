...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ProfessionalProfileWidget.routeName,
          path: ProfessionalProfileWidget.routePath,
          asyncParams: {
            'perfil': getDoc(['Users'], UsersRecord.fromSnapshot),
          },
          builder: (context, params) => ProfessionalProfileWidget(
